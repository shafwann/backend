...
Route::get('/profil88', [Data88Controller::class, 'adddata88'])->middleware('auth')->middleware('active');
Route::get('/edit88/{id}', [Data88Controller::class, 'editData88'])->middleware('auth')->middleware('active')->name('/edit88/{id}');
Route::post('/prosesedit88', [Data88Controller::class, 'prosesedit88'])->middleware('auth')->middleware('active');
